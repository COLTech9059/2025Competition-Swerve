...
public class TunerConstants {
  ...
  private static final ClosedLoopRampsConfigs steerRampConfigs =
      new ClosedLoopRampsConfigs().withVoltageClosedLoopRampPeriod(.1); // .05
  private static final ClosedLoopRampsConfigs driveRampConfigs =
      new ClosedLoopRampsConfigs().withVoltageClosedLoopRampPeriod(.35); // .35
  // Initial configs for the drive and steer motors and the azimuth encoder; these cannot be null.
  // Some configs will be overwritten; check the `with*InitialConfigs()` API documentation.
  private static final TalonFXConfiguration driveInitialConfigs =
      new TalonFXConfiguration().withClosedLoopRamps(driveRampConfigs);
  private static final TalonFXConfiguration steerInitialConfigs =
      new TalonFXConfiguration()
          ...
          .withClosedLoopRamps(steerRampConfigs);
  ...
  private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.077880859375);
  ...
  private static final Angle kBackLeftEncoderOffset = Rotations.of(0.219970703125);
  ...
  private static final Angle kBackRightEncoderOffset = Rotations.of(-0.01953125);
