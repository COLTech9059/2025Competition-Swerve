...
public class LEDs extends RBSISubsystem {
   ...
   *
   * @param pattern The name of the pattern you want (this is pulled from a switch case, so there is
   *     limited options)
   */
  ...
  /**
   * Set the LEDs to a solid color pattern, specified by an integer shift from the first solid color
   * pattern in the list
   *
   * @param shift Integer shift value to apply. Check the Blinkin pattern chart to see what the
   *     pattern will be)
   */
